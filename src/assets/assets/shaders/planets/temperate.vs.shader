...
float evaluateNoise(){
    Noise settings[] = {{0.1, .06} , {1, 0.04}, {3, 0.025}, {10, 0.01}, {20, 0.005}, {50, 0.005},  {100, 0.001}, {200, 0.005}, {1000, 0.001}};
    //Noise settings[] = {{1, .1} , {5, 0.01}, {10, 0.01}, {20, 0.01}, {60, 0.009}, {1000, 0.001}};
    float noiseValue = 0;
    for(int i = 0; i < 9; i++){
        Noise n = settings[i];
        noiseValue += noise(aPos + (noiseValue * 3),n.roughness, n.strength);
    }
